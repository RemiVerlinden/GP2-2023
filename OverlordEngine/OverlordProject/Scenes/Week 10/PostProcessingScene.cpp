...
void PostProcessingScene::Initialize()
{
	...
	pPeasantMaterial->SetDiffuseTexture(L"Labs/Week10/Textures/PeasantGirl_Diffuse.png");
	...
	pGroundMaterial->SetDiffuseTexture(L"Labs/Week10/Textures/GroundBrick.jpg");

	//Ground Mesh
	//***********
	const auto pGroundObj = new GameObject();
	const auto pGroundModel = new ModelComponent(L"Labs/Week10/Meshes/UnitPlane.ovm");
	...
	const auto pModel = pObject->AddComponent(new ModelComponent(L"Labs/Week10/Meshes/PeasantGirl.ovm"));
