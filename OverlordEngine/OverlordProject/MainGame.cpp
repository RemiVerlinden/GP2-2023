...
#include "Scenes\Portal\PortalScene.h"
#endif
...
void MainGame::OnGamePreparing(GameContext& gameContext)
{
	...
	//gameContext.windowTitle = L"GP2 - Milestone 1 (2023) | (2DAE07) Verlinden Remi";
	//gameContext.windowTitle = L"GP2 - Milestone 2 (2023) | (2DAE13) Doe John";
	gameContext.windowTitle = L"GP2 - Exam Project (2023) | (2DAE07) Verlinden Remi";
}
